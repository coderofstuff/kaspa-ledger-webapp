...
const Body = () => {
    const deviceTypeChanged = (deviceType) => {
        document.getElementById("addressgen").scrollIntoView({behavior: "smooth"});
    };

    const onUseAddressGenerator = (e) => {
        document.getElementById("addressVerify").scrollIntoView({behavior: "smooth"});
    }

    const verifyAddress = (e) => {
        document.getElementById("checkAddress").scrollIntoView({behavior: "smooth"});
    }
